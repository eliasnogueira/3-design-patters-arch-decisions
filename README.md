...
Creates an approach to generate non-sensitive data for your test without manually changing the test data in each execution.
...
commonly refer it as Data Factory.
...
Normally, this approach accepts dynamic values injection through environment variables or by modifying a configuration file.
...
* Allure configuration placed on [pom.xml](https://github.com/eliasnogueira/3-design-patters-arch-decisions/blob/main/pom.xml)
